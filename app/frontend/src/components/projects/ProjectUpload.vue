...
const translatedDataTable = ref<any>('');
const formatDataTable = ref<any>('');
...
<template>
    <div class="project-upload">
        <button class="project-upload-button" title="UPLOAD" @click="isOpenUploadPanel = true;">
        ...
        <div class="project-upload-body" v-show="isOpenUploadPanel">
            <div class="project-upload-body">
                <div class="project-upload-body-panel">
                    <div class="project-upload-body-panel-header">
                        ...
                        <div class="project-upload-body-panel-header-close" @click="isOpenUploadPanel = false">
