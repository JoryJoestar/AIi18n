...
class Project(Base):
    ...
    created_at = Column(String, default=datetime.datetime.now(datetime.timezone.utc), nullable=False)  # 创建时间
    updated_at = Column(String, default=datetime.datetime.now(datetime.timezone.utc), onupdate=datetime.datetime.now(datetime.timezone.utc), nullable=False)  # 更新时间
